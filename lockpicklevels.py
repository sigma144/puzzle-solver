...
p210x = parse('o(O0o|OoP2c|OoC2p2|Oc|Po4|O0(P2p2C2O0P0$|Oc2Po2|PCpO2c2', 12, special='2-10') #Demo only
p210 = parse('o(O0o|OoP3c2|OoC2p2|Oc|Po4|O0(P2p2C2O0P0$|Oc2Po2|PCpO2c2', 16, special='2-10') #Full game only
...
p45x = parse('w(Kw!Orw|W4r|WoKo!CkR0O0!Oow|Oc2Cw3Ro|OcKoWo2Ow|OkCk!W0o|Wo!Co!Rc|!O2!W2$', 18) #Demo only
p45 = parse('rw4o4c3(!W!W|OO)(CW|OR)(!W!O|CC)(!W!O|WC)(CW|OR)(OC|WC)$', 8) #Full game only
p46 = parse('b3(WoWow|#KwKc|BkWoWb|BkWc|R$|OwOw|Ko#Kc|BkWwOw|BkOc|#C2CCm', 22)
p47 = parse('m2(Rx|Gx|Bx|R2bG2g2!B0r2#R0b2R2m2|G2g2G0b@R2g2G0r2R0m2|B2r2B0g2#G0b2G2b2G0m2|!R0r2B0g2!B2g2G0b#B0m2|M8B6$', 25)
...
p4B = parse('!R0@G0#B0M0(!@#W0$|#M4r|G3b2#G0m)|g4G2m|r5R4|b2B3R|m2@B3Gx|#R0g=4|!G2B2!M0b3@R0#B0b2@B2#G0m4', 20)
...
p52 = parse('W2W2W4|W2W2W6p2|n8N0C0mM0C0OOKKPP$|c7(C5o2|C0C2k2', 10)
p52x = parse('w(CCCBxCCC$|WpPwPpPoWoc2|WoOwOwOoPwc2|WnWnOpOpPnc2', 14) #Demo only
p53 = parse('o8p6k9c40(n|n5|n8|n9|W30$|CxC30w6|WxC5Ow6|OxP4P5K3w6|PxC5K3w6|KxO7O15K3w6', 16, special='5-3')
p54 = parse('m24(M4M2|N3MM3)(M3M2M3|MM8)(M6n10|M3M2(M3M3N3|M3M0N0|MM4M3M)(M2N2N4M2|M2M4M2M)M24M0$', 10, special='5-4')
p55 = parse('k10(N2k25|K3K2|K4|K2N4|K2n10K5N6|K0K12(K0K2K0K0$|K6n15K6|N2n15|N2K4', 15)
...
p68 = parse('O2p-2C2o-2C-2o2O0c2P2p2P0c-2O-2c2C|O0p2P0c-2C0o-2O0p2C2c2P-2o-2C2p2P|P0o2O2p-2P0o2P-2c2O-2p-2P0p-2C-2o2O|OO0PP0CC0$', 18)
p69 = parse('w-2w-W2(g4R-2r-2g-@R-2G3w6|wr2G2r-2|w-2g-w-2R-2w3g|wR2wr-2|w-r-!W16$', 13)
p610 = parse('U25$|(P-4p4C-xu-U3u3b=0c-U-3|c9C3b#P0u-#P0u-4u-M-3u4N0|p-5P-xu5B0c-C3n3U|mUxu4U2bC-x|PxbUu4#B3)u-6', 19, special='6-10')
...
p73x = parse('o5c7C/OxO/Cx(C/Ox(c-|C/Oxc)|O0C0$|O/Cx(o-|O/Cxo)', 8) #Demo only
p73 = parse('o5c7C/OxO/Cx(r-1|r-2|r-4|r-8|r-16|r-32|o=2>(OC/R-xC/R-xO|OC/R-xC/R-xC/R-xO|OC/R-xC/R-xC/R-xC/R-xO|OC/R-xC/R-xC/R-xC/R-xC/R-xO)L/CxL-97L0$', 7) #Full game only
...
p7A = parse('P256$|p4P/C-xC/Px|C-4P/C-xP/C-x|P24P/C-x|P2C/Px|PC/Px|P8C/PxP/C-xC/Px|PxP/C-x|C-xC/Px|C-2P/C-x', 11) #Max possible score is 568
...
p86 = parse('b(BM0m-1c12W12bu|BM0W4m-2bWw5u|BU4M0M/B0M/W0M/C0$|BM0C4m2bCc5u|BM0mw12C12bu', 13)
...
p105 = parse('B0p3n-4u|P-2n-|C|Z-4|P3b-4u|P-3n-8|p-8|Z-8|U2U/[B0N0]$', 12) #Preservation
p106 = parse('w50u-7(N0(Z50$|W0u-4m-1)|U-2M-1m*n*z50|U-2p5P6P0O-4|U-2o-4O-6O0P5|U-2o-7O-1n6|U-2p*o*w-50', 11, passing_effect=[2]) #Passing curse
p107 = parse('N/W6|M/W6|w6n=0|K0k51W/[M0N0U0CZ50]$|[KU0]M6c|[KxU0]c|z-m-', 12)
p108 = parse('o12O/[](W0O/[]C/[]|W/[](U64$|W20u20|Z4Z3u7|z24|z19|z9|Z8Z4Z3u15|O14u14|C8u8', 15)
...
pPt2x = parse('ow(OpBwPkCb|Wo(BWos|PkCbBB$|KcBwKc|OpKcWo|PkOpKcCb', 7, 15, salvage='W') #Demo only
pPt2 = parse('m2(C-6wK4l-3|k6(w-1#W0Kxk7B3|K2C/K6b3|L-3K8)|(K#B0W0|WsL-3)U/K0$', 7, 6, salvage='W') #Full game only
...
pt13ss = parse(pt13.level, 0, 12, salvage='Zx')
...
pt17 = parse('wP400$|P2C/Px|p4wP/C-xC/Px|PC/Px|wC-4P/C-xP/C-x|wP24P/C-x|wP8C/PxP/C-xC/Px|PxP/C-x|C-xC/Px|C-2P/C-x|>(P7C-7W0s4|P0C0L0)', 11, 12, salvage='L0', special='T1-7') #Takes a while (1 min)
...
pt25ss = parse(pt25.level, 1, 13, salvage='K=', salvage_id=8)
...
pt37 = parse('s=32s=33s=34|c20(S32|S33|S34|[C7O-3]|[C16C16]|[C-4C-9]|[CO-16]|[C5O-20]')
pt3w = parse('u5o-4p9(S32|Up-|Uo12|Uo-2|K-4K0(S33|Uo|Up2|Up-|K13K0(S34|Uo-|Up-4|Uo-|K15K0$', 31, salvage_from=[pt37, pt37, pt37, pt37], omega='opk') #Takes a long time (3 min)

pt4W = parse('E|e11w80l-1i(S23|S24|S25|S26|W2|W3|[W=W=W=][W=W=W=]|[W=W=W=][W=W=W=]|W10|W30|W1000W0$', 6)
pt41 = parse('w10o10p10k10([O=O=]|m-1C/[W=O=P=K=]L/[W0O0P0K0]U4C$|K2O2W8P5u|PK2O4K2u|P4KOu|K3O2OW2u', 13) #Takes a bit (1.5 min)
pt4R = parse(pt4W.level[:-1]+'|R1iw-35k5r10W0(w2n-L/[G-425B-10]$|(WR6W|WK4W)(N/W|(WK4W|WnKW)(WR2K2W|WR8W)(WR2K2W|WR4W)R3N/[K0R0W0U0]$', 18, salvage='N/W', salvage_start={23:'R/L-1i'}) #Takes a while (1 min)
...
p129 = parse('W0w20l-5(W2m-1L-2M0L0L-2l-4N-2L2L0{W0L0}u-1|W8m4WW4M0n-4{W0L0}u-1|{m=0}<C/[WL-1M0]|{z}{M0U-1N0}u-{w=1}{l=-1}(U2$', 22, special='12-9') #Takes a while (2.3 min)
...
pomegaP = parse('m-1U/M0|S5|(<|#U/B0|[C-8U0])(b18u4[U0B0]|S6S6S6S6S6)|r5|g5|b1+1i|S9|S10|S11|k50U/K0k-50(u-4|U/K0l-6U/L0)|S7|S8|U/OU/O-1U/OU/O-1U/O$|U/C-999999999|L/[R-xG-xB-xO-xU0]',
    salvage_from=[], salvage_start={5:'O/U', 6:'B3', 7:'K=', 8:'K=', 9:'[RxRxP0]', 10:'[GxGxP0]', 11:'[BxBxP0]'}, omega='wo', max_stacks=2) #Timeout
pomegaK = parse(pt31.level, 10, special='T3-1', salvage_start={12:'O-4'}, omega='wop')
...
pomegaN = parse('m-1U/M0|S5|(>|#U/B0|[C-8U0])(b18u4[U0B0]|S6S6S6S6S6)|r5|g5|b1+1i|S9|S10|S11|k50U/K0k-50(u-4|U/K0l-6U/L0)|S7|S8|U/OU/O-1U/OU/O-1U/O|U/C-999999999$|L/[R-xG-xB-xO-xU0]',
    salvage_from=[pt21m, pt23, pt25, pt27], salvage_start={5:'O/U', 6:'B3', 7:'O/W=', 8:'O/W=', 9:'W/[RxRxP0]', 10:'[OxGxP0]', 11:'[OxBxP0]'}, omega='okc', max_stacks=2) #Timeout
...
pomegaE = parse('e=8(e=-8|e*{L0}l1i(s=51s=52|u10+1i(E-3E3E-3E3E-3$|E-2U6u-20U12e-*|E3e-*e-9U-5u-|E-xE2u-E8e-u-1i|S51|S52|Ux{e}|{e=12}u*S53<{E}e-1{U0E0}$', omega='w', special='omegaE') #Takes a very long time (45 min) with purges 24, 27, 31
#pomegaM = parse()
...
pex3 = parse('s=46s=47|u15(C/U15S46u-3|[C-1U]S47u-3|C-3o-40[C0U0]$|ZZ4Z4u-3|C2O-20z-u-3|O-20Z-8u-3', 24, omega='woc') #Takes a while(1.8 min)
pex4 = parse('s=48s=49s=50|l4(L4L-2X-1|L0L4l-5!C0@C0#C0U/L0$|nMR/[]N-5$|#U0L0m|@M12z-|S48l=0m-1S49S50', omega='rgbl') #Timeout
pex5 = parse(pomegaE.level.replace('$','').replace('<','') + '$', 19, salvage_start={51:'W/Ux', 52:'U/W-5', 53:'Ux'}, omega='we', special='EX-5') #Takes a very long time (15 min)
...
po17 = parse('w((OpPl<K>|WwOwWw)(OcPok|OwPk|KwOk)|Pw|(OoWcOo|WpPpW)(OwOoLk|Po|(<K>wPpW|OpPoW)lk)|(OpPlPpO|WoCoOlWp|OoWo<K>oW)PoKw(PoOwP|WlClO|<K>wCoL)l(Pl<K>p<K>|LwKoCw)(PoOoKKK$|WwOoPk|<K>wLcKk)') #Takes a long time (5.7 min)
...
salvageSources = [pPt2,pt11,pt13,pt15,pt17,pt21s,pt23,pt25,pt25s,pt27,pt27s,pt27ss,
