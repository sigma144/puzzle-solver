...
p210 = parse('o(O0o|OoP2c|OoC2p2|Oc|Po4|O0(P2p2C2O0P0$|Oc2Po2|PCpO2c2', 12, special='2-10') #Bridge edge case
p210i = parse('o(O0o|OoP2c|OoC2p2|Oc|Po4|O0(P2p2C2O0P0$|Oc2Po2|PCpO2c2^', 12, special='2-10') #Likely intended solution
...
p8A = parse('m-5N/M-5b|c5M/C5b|n5N/C5b|U/M-xU/M0U/M-xU/M0U/M-xU/M0U/M-x#U/N0$', 41, max_stacks=3) #Takes a bit (0.6 min)
...
p93 = parse('(wWxw4Wxw|o2Oxo2Oxo3|pPxp3Pxp2|c3Cxc2Cxc)(wWxwWxw=1|o2Oxo2Oxo=1|p3Pxp3Pxp=1|c3Cxc2Cxc=1)B/[WxOxPxCx]B-32$', 16, special='9-3') #Timeout
...
p9C = parse('wo3p6k10c15b21m-9(W/Bx|B/Cx|C/Kx|K/Px|P/Ox|O/Wx|[BW0M0]|[B0K0C0W0O0P0]$', 26, max_stacks=2, special='9-C') #Timeout
...
p1010 = parse('u4m-1m3M/[OxGxBxRxU0]$|U[Z-xZ-x]|U[ZxZxZx]|UZ/Mx|UZ/U|UZ/[OOOO]|U[NxN-x]|UO/[]R/[]G/[]B/[]|UM/[]N/[]M/[]N/[]', 30, max_stacks=2) #Takes a long time (7 min)
...
p10C = parse('c50b-90m-1m*(z-b-z-|[C10Zx]|[B-20Z-x]|O/[C0B0U0]$|n10n10n10n10n10n10n10n10n10n10n10n10n10n10n10n10n10n10n10n10', 25, max_stacks=2) #Takes a very long time (15 min)
...
p61x = parse('b8|BxB-xBxB-xBxB-xBxB-x$|B2(b3(B2B-2b-4))|B4b-5B0B3(b4B4B0b-3B2b4|B-4B0(B2b3|b6(B2b3|B-4B0(B4b4B2b-9B-5b12|B4B0bB2B-3b-5'); add_edge(p61x, 1, 'B2', 5); add_edge(p61x, 3, 'Bx#B-x', 11) #Takes a while (3.5 min)
...
k53 = parse('w4(WW6|WW2(W2W0w4W0w4|W2W0w4W0w4|W2W0w4W2W0w4W0W8W0W3W0W6W6W0W2W0W8(w4|WW0$'); add_edge(k53, 1, 'W0', 5)
k54 = parse('w2o2(W2W0o2|W2O2w4|W6w3|W2O2o4|O8o|O2O0w2|W0w2|WW0o6|OO0$')
k55 = parse('w2m(O4w2|W0w4W4o4O0w2W0(o2(O6w4W0w2O0w2W0$'); add_edge(k55, 1, 'W6', 2); add_edge(k55, 3, 'O0w2W6w2W0o2', 2); add_edge(k55, 5, 'W4o2W0w2O0w2W6', 2)
...
k70 = parse('C0R0g|!C0@C0(g|!@C0$)|@C0(C0r|!C0g|G0(!C0Rg|!@C0()|C0C0(!C0g'); add_edge(k70, 0, 'C0', 7); add_edge(k70, 1, '!G2', 7); add_edge(k70, 7, 'C0', 9); add_edge(k70, 1, 'C0!G0', 9)
...
k81 = parse('c9c9c9c9((c-5c-7c2|c-3c-8c|c-5c-6)(c-7c|c-3c-4|c-6)C24$|(c-3c-7c2|c-3c-4|c-9c|c-8)(c-4c-6c|c-1c-3c-4|c-3c-82|c-9) '); add_edge(k81, 10, 'c-3', 6) #Takes too long
...
kex5 = parse('W(oGpOgPoOcPw|OgPoGkKpCgG(OoGWco|pKKK$))|(wCkOkCgPgCcKwO|WcKwGpCcGgPpK)oCkWkCcc|(KcGcKoOpOoCk|CkCwOpGoPcK)PpOoGgWgo'); add_edge(kex5, 6, 'WkCkCgOpPgGkP', 8)